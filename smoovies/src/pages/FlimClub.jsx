...
import { Box, IconButton, Stack, Typography, Icon, Paper, Grid, useTheme, useMediaQuery, useThemeProps, createTheme } from '@mui/material';
...
export const FilmClub = () => {
  ...
  return (
    ...
    <Grid container spacing={1} justifyContent={'center'} alignItems={'center'}>
        ...
        {isMobile ? (<Paper elevation={24} sx={{ width:'90%', height:'100%', margin:'auto',  marginTop: '40px', marginBottom:'80px'}}>
    ...
    <Grid item xs={12}  md={3}>
        {isMobile ? (<Paper elevation={4} sx={{ width:'90%', height:'100%', marginTop: '100px', marginBottom:'40px', marginLeft:'0.875rem' }} >
        <Card width={'100%'} height={'100%'}>
